...
#define LMR_OPERATION_CASE_SWITCH(L, _field, operation)                \
	...
	case LUA_TNUMBER:                                                  \
		...
		return 1;                                                      \
	case LUA_TSTRING:                                                  \
		uc->p = (ua->_field)##operation##(lmr_string_to_uint32(L, b)); \
		return 1;                                                      \
	case LUA_TUSERDATA:                                                \
		ub = get_udata(b);                                             \
		switch (ub->tt)                                                \
...
#define LMR_TEST_CASE_SWITCH(L, _field, operation)                             \
	...
	case LUA_TNUMBER:                                                          \
		...
		return 1;                                                              \
	case LUA_TSTRING:                                                          \
		lua_pushboolean(L, (_field)##operation##(lmr_string_to_uint32(L, b))); \
		return 1;                                                              \
	case LUA_TUSERDATA:                                                        \
		ub = get_udata(b);                                                     \
		switch (ub->tt)                                                        \
...
#define LMR_aUSERDATA_TEST_CASE_LMR(L, operation)                              \
	case LUA_TPOINTER:                                                         \
		...
		{                                                                      \
		case LUA_TSTRING:                                                      \
			lua_pushboolean(L, (p)##operation##(lmr_string_to_pointer(L, b))); \
			return 1;                                                          \
		case LUA_TUSERDATA:                                                    \
			ub = get_udata(b);                                                 \
			switch (ub->tt)                                                    \
